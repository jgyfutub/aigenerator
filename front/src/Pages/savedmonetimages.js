...
export default function SavedMonetImages(){
    ...
    const getimgpaths=async(formdata)=>{
        const response=await axios.post('http://127.0.0.1:5000/savedmonetimages/',formdata)
    ...
    return(
        <div>
            ...
            <h1 style={{marginTop:'60px'}}>Saved Monet Images</h1>
            <div>
