...
class ReactView(APIView):
    def post(self,request):
        ...
        imagegenerated.save('C:/Users/Acer/OneDrive/Desktop/imagegenerator/pybackend/myproject/media/images.png','PNG' )
        imagegenerated_bytes=imagegenerated.tobytes()
        imagegenerated_base64=base64.b64encode(imagegenerated_bytes).decode('utf-8')
        return JsonResponse({'message':'django connected!!','image':imagegenerated_base64})
